...
private:
    ...
    ErrorOr<FieldInfo> parse_field(NonnullOwnPtr<ConstantPool> const& constant_pool);
    ErrorOr<AttributeInfo> parse_attribute(NonnullOwnPtr<ConstantPool> const& constant_pool);
